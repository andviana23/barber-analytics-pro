# Script para aplicar migração da tabela expense_payments
# Execute este script no Supabase SQL Editor

Write-Host "Aplicando migração da tabela expense_payments..." -ForegroundColor Green

# O SQL abaixo deve ser executado no Supabase SQL Editor
$sql = @"
...
Write-Host "SQL para executar no Supabase:" -ForegroundColor Yellow
