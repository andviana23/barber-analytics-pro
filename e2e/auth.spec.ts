...
test.describe('Autenticação', () => {
  test('realiza login com credenciais válidas', async ({ page }) => {
    test.skip(true, 'Implementar quando rota de login e seletores estiverem definidos.');
  ...
  test('exibe mensagem para credenciais inválidas', async ({ page }) => {
    test.skip(true, 'Implementar quando mensagens de erro estiverem definidas.');
