...
test.describe('Lista da Vez', () => {
  test('adiciona ponto e verifica reordenação', async ({ page }) => {
    test.skip(true, 'Implementar após definir seletores e dados seed para Lista da Vez.');
  ...
  test('visualiza histórico mensal após reset', async ({ page }) => {
    test.skip(true, 'Implementar após sementes do histórico serem configuradas.');
