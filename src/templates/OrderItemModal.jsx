        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="w-10 h-10 rounded-lg border border-light-border dark:border-dark-border bg-white dark:bg-dark-surface text-theme-primary hover:bg-light-surface dark:hover:bg-dark-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            >
              <svg
                className="w-5 h-5"
                fill="none"
            ...
            <input
              ...
              min={1}
              max={99}
              className={`flex-1 px-4 py-2.5 rounded-lg border bg-white dark:bg-dark-surface text-theme-primary text-center font-semibold text-lg focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:opacity-60 disabled:cursor-not-allowed ${
                errors.quantity
