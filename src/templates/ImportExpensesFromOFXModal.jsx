        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {currentStep === 2 && normalizedData.length > 0 && (
            <div className="p-6 space-y-4">
              ...
              <div className="overflow-x-auto -mx-6 px-6">
                <table className="min-w-full border border-light-border dark:border-dark-border rounded-lg text-sm">
                  <thead className="bg-light-bg dark:bg-dark-bg dark:bg-dark-surface">
                    <tr>
                      <th className="px-2 py-2 text-left text-xs font-medium text-theme-secondary dark:text-light-text-muted dark:text-dark-text-muted uppercase">
                        Data
                      </th>
                      <th className="px-2 py-2 text-left text-xs font-medium text-theme-secondary dark:text-light-text-muted dark:text-dark-text-muted uppercase">
                        Descrição
                      </th>
                      <th className="px-2 py-2 text-right text-xs font-medium text-theme-secondary dark:text-light-text-muted dark:text-dark-text-muted uppercase">
                        Valor
                      </th>
                      <th className="px-2 py-2 text-left text-xs font-medium text-theme-secondary dark:text-light-text-muted dark:text-dark-text-muted uppercase">
                        Categoria
          ...
          {currentStep === 3 && enrichedData.length > 0 && previewStats && (
            <div className="p-6 space-y-4">
              ...
              <div>
                <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-2">
                  Preview (Primeiras 10 linhas)
                </h4>
                <div className="overflow-x-auto -mx-6 px-6">
                  <table className="min-w-full border border-light-border dark:border-dark-border rounded-lg text-xs">
                    <thead className="bg-light-bg dark:bg-dark-bg dark:bg-dark-surface">
                      <tr>
                        <th className="px-2 py-1.5 text-left text-xs font-medium text-theme-secondary dark:text-light-text-muted dark:text-dark-text-muted">
                          Data
                        </th>
                        <th className="px-2 py-1.5 text-left text-xs font-medium text-theme-secondary dark:text-light-text-muted dark:text-dark-text-muted">
                          Descrição
                        </th>
                        <th className="px-2 py-1.5 text-right text-xs font-medium text-theme-secondary dark:text-light-text-muted dark:text-dark-text-muted">
                          Valor
                        </th>
                        <th className="px-2 py-1.5 text-left text-xs font-medium text-theme-secondary dark:text-light-text-muted dark:text-dark-text-muted">
                          Categoria
                        </th>
                        <th className="px-2 py-1.5 text-center text-xs font-medium text-theme-secondary dark:text-light-text-muted dark:text-dark-text-muted">
                          Status
                        </th>
                      </tr>
                    </thead>
