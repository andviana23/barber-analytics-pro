  ...
  return (
    <div ref={containerRef} className={`relative ${className}`}>
        ...
        className={`
          ...
          ${
            disabled || loading
              ...
              : 'bg-white dark:bg-dark-surface hover:border-primary cursor-pointer'
          }
          ${
            error
      ...
      >
        ...
        {/* Icon */}
        <svg
          className={`w-5 h-5 text-theme-secondary transition-transform flex-shrink-0 ${
            isOpen ? 'rotate-180' : ''
          }`}
          fill="none"
          stroke="currentColor"
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute z-50 w-full mt-2 bg-white dark:bg-dark-surface border border-light-border dark:border-dark-border rounded-lg shadow-lg max-h-80 flex flex-col">
          {/* Search Input */}
