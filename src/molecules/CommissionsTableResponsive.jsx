  ...
  const EditableInput = ({ item }) => (
    <div className="flex flex-col items-center gap-1">
      <input
        ...
        className={`w-20 px-2 py-1 border rounded-md text-right bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 transition-colors ${
          validationError
            ? 'border-red-500 dark:border-red-400 focus:ring-red-500/50 focus:border-red-500'
            : 'border-zinc-300 dark:border-zinc-600 focus:ring-blue-500/50 focus:border-blue-500'
        }`}
