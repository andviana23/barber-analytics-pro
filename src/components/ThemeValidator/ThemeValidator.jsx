        ...
        delay: index * 0.1
            ...
            border: `1px solid ${result.foreground}20`
              ...
              <div className="flex items-center space-x-2 text-xs">
                ...
                <span className="text-light-text-muted dark:text-dark-text-muted">sobre</span>
                <div className="flex items-center space-x-1">
                  <div className="w-3 h-3 rounded border" style={{
                backgroundColor: result.background
              }} />
      ...
      duration: 0.2
        ...
        {activeTab === 'responsiveness' && <div className="space-y-4">
            <Card className="p-6">
              ...
              width: '1920px+',
              label: '4K'
            }].map(bp => <div key={bp.size} className="text-center p-3 bg-light-bg dark:bg-dark-bg dark:bg-dark-surface rounded">
                    ...
                    <div className="text-xs text-theme-secondary mt-1">{bp.label}</div>
                  </div>)}
              </div>
            </Card>
          </div>}
