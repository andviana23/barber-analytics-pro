...
export function AuthDiagnostic() {
  ...
  return <div className="space-y-4">
      ...
      <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
        ...
        {diagnostics.professionalQuery?.error && <div className="mt-2 p-2 bg-red-100 border border-red-300 rounded">
      ...
      <div className="p-4 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-lg">
        <h3 className="font-semibold text-theme-primary mb-2">🎯 Recomendações</h3>
