...
export function AuthDiagnostic() {
  ...
  if (!user) {
    return (
      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        <h3 className="font-semibold text-yellow-800">⚠️ Usuário não autenticado</h3>
        <p className="text-yellow-700">Faça login para executar os diagnósticos.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-bold mb-4">🔍 Diagnóstico de Autenticação</h2>
      ...
      <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
        <h3 className="font-semibold text-green-800 mb-2">2. Sessão Supabase</h3>
      ...
      <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
        <h3 className="font-semibold text-orange-800 mb-2">4. Query de Profissionais</h3>
        ...
        {diagnostics.professionalQuery?.error && (
          <div className="mt-2 p-2 bg-red-100 border border-red-300 rounded">
            ...
            <p className="text-red-700">{diagnostics.professionalQuery.error.message}</p>
          </div>
        )}
      </div>
      ...
      <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
        ...
        <ul className="list-disc list-inside space-y-1 text-gray-700">
          <li>Se RLS Test falhar: Problema nas políticas RLS ou usuário sem perfil</li>
          <li>Se Professional Query falhar: Verificar se usuário tem permissão na tabela</li>
          <li>Se AuthContext e Supabase Session divergirem: Problema de sincronização</li>
