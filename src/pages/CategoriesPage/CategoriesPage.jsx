  ...
  const renderCategoryRow = (category, isSubcategory = false) => {
    ...
    return (
      <div key={category.id}>
        ...
        <div
          className={`flex items-center justify-between px-4 py-3 hover:bg-light-hover dark:hover:bg-dark-hover transition-colors border-b border-light-border dark:border-dark-border ${
            isSubcategory ? 'pl-12 bg-light-bg dark:bg-dark-bg' : ''
          }`}
        >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-light-border dark:border-dark-border bg-light-hover dark:bg-dark-hover">
          ...
          {canManage && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-success hover:bg-success/90 text-white rounded-lg transition-colors text-sm font-medium"
            >
