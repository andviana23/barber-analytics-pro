      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={e =>
              onFiltersChange({ ...filters, periodo: e.target.value })
            }
        ...
        <div>
          ...
          <select
            ...
            onChange={e =>
              onFiltersChange({ ...filters, unidade: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={e =>
              onFiltersChange({ ...filters, formato: e.target.value })
            }
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          >
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-6">
