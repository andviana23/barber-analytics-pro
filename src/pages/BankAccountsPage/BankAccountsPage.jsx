...
export function BankAccountsPage() {
  ...
  return (
    <div className="min-h-screen bg-light-bg p-6 dark:bg-dark-bg">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-dark-text-primary flex items-center gap-2 rounded-xl bg-gradient-success px-5 py-3 font-semibold shadow-lg transition-all hover:scale-105 hover:opacity-90 hover:shadow-xl"
            >
        ...
        {selectedUnit && (
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="card-theme inline-flex items-center gap-2 rounded-lg px-4 py-2 transition-colors hover:bg-gray-200 dark:bg-dark-surface dark:bg-gray-700 dark:hover:bg-gray-700"
            >
              {showBalances ? (
                <>
      ...
      {/* Saldo Consolidado */}
      {consolidatedBalance && (
        <div className="card-theme mb-8 rounded-3xl border-2 border-blue-200 bg-blue-50 p-8 shadow-2xl dark:border-blue-800 dark:bg-blue-900/20">
      ...
      {loading ? (
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="card-theme animate-pulse rounded-2xl p-6 shadow-lg"
            >
        ...
        <div className="card-theme rounded-3xl p-12 text-center shadow-xl">
          ...
          <button
            onClick={() => setModalCreate(true)}
            className="text-dark-text-primary inline-flex items-center gap-2 rounded-xl bg-gradient-primary px-6 py-3 font-semibold shadow-lg transition-all hover:from-blue-700 hover:to-blue-800"
          >
            <Plus className="h-5 w-5" />
...
const BankAccountCard = ({
  ...
  return (
    <div
      className={`card-theme rounded-2xl border-2 p-6 shadow-lg transition-all duration-300 hover:shadow-2xl ${account.is_active ? 'border-light-border dark:border-dark-border' : 'border-red-300 opacity-60 dark:border-red-800'}`}
    >
      {/* Header */}
      <div className="mb-4 flex items-start justify-between">
        ...
        {!account.is_active && (
          <span className="rounded-lg bg-red-100 px-2 py-1 text-xs font-bold text-red-600 dark:bg-red-900/30 dark:text-red-400">
            Inativa
          </span>
        )}
      </div>
        ...
        <div>
          <div className="mb-1 flex items-center justify-between">
            ...
            <button
              ...
              className="hover:card-theme rounded p-1 transition-colors dark:hover:bg-gray-700"
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-600 transition-colors hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/30"
        >
        ...
        <button
          onClick={onRefresh}
          className="card-theme rounded-lg px-3 py-2 transition-colors hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="card-theme w-full max-w-md rounded-2xl p-6 shadow-2xl">
        <div className="mb-6 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="hover:card-theme rounded-lg p-2 transition-colors dark:hover:bg-gray-700"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="card-theme w-full rounded-lg border-2 border-light-border px-4 py-3 text-text-light-primary focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/50 dark:border-dark-border dark:text-text-dark-primary"
              required
            />
          </div>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              rows={3}
              className="card-theme w-full resize-none rounded-lg border-2 border-light-border px-4 py-3 text-text-light-primary focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/50 dark:border-dark-border dark:text-text-dark-primary"
              placeholder="Ex: Ajuste de saldo após auditoria"
            />
          </div>

          {error && (
            <div className="mb-4 flex items-center gap-2 rounded-lg border-2 border-red-200 bg-red-50 p-3 dark:border-red-800 dark:bg-red-900/20">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="card-theme flex-1 rounded-lg px-4 py-3 font-semibold text-gray-700 transition-colors hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:text-gray-600 dark:hover:bg-gray-600"
            >
              Cancelar
            </button>
            <button
              type="submit"
              disabled={loading}
              className="btn-theme-primary flex-1 rounded-lg px-4 py-3 disabled:opacity-50"
            >
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {history.map(log => (
              <div
                key={log.id}
                className="rounded-lg border-2 border-light-border p-4 transition-colors hover:bg-light-bg dark:border-dark-border dark:bg-dark-bg dark:hover:bg-dark-surface/50"
              >
                ...
                {log.change_reason && (
                  <p className="text-sm italic text-text-light-secondary dark:text-text-dark-secondary">
                    {log.change_reason}
                  </p>
                )}
              </div>
