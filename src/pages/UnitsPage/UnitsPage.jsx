          ...
          <div className="text-center max-w-md mx-auto">
            ...
            {canCreate && !searchTerm && (
              <button
                ...
                className="inline-flex items-center px-8 py-4 bg-blue-600 hover:bg-blue-700 text-dark-text-primary font-bold text-lg rounded-xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105"
              >
  ...
  return (
    <MainContainer>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                disabled={loading}
                className="inline-flex items-center justify-center px-4 py-2.5 card-theme dark:bg-dark-surface hover:bg-light-bg dark:bg-dark-bg dark:hover:bg-gray-700 border-2 border-light-border dark:border-dark-border text-gray-700 dark:text-gray-300 dark:text-gray-600 dark:text-gray-200 font-medium rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <div className="mb-6 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 flex-1">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 card-theme dark:bg-dark-surface border border-light-border dark:border-dark-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-2 card-theme dark:bg-dark-surface border border-light-border dark:border-dark-border rounded-xl px-4 py-2.5">
            ...
            <select
              ...
              className="bg-transparent border-none focus:ring-0 text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 dark:text-gray-200 cursor-pointer"
            >
        ...
        {canViewStats && (
          <div className="flex rounded-xl card-theme dark:bg-dark-surface p-1 border border-light-border dark:border-dark-border">
            <button
              onClick={() => setView('cards')}
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all ${view === 'cards' ? 'bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'}`}
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all ${view === 'stats' ? 'bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'}`}
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all ${view === 'comparison' ? 'bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'}`}
      ...
      {loading && view === 'cards' /* Loading State */ ? (
        ...
        <Card className="p-12">
          <div className="text-center">
            ...
            <button
              onClick={handleRefresh}
              className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-dark-text-primary font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all"
            >
