...
/**
 * AtomsDemo - Página de demonstração dos novos atoms
 *
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-theme-secondary">
            Demonstração dos novos componentes: CurrencyInput, TimeInput e
            ProtectedButton
          </p>
        </div>
        ...
        <Card className="p-6">
          ...
          <details className="mt-6">
            ...
            <pre className="mt-2 p-4 bg-light-surface dark:bg-dark-surface rounded-md overflow-x-auto text-xs">
              <code>{`<CurrencyInput
  label="Saldo Inicial"
  value={saldoInicial}
  onChange={setSaldoInicial}
...
/>`}</code>
  ...
  loading={loading}
  showTooltipWhenHidden={true}
  tooltipMessage="Apenas Gerentes podem cadastrar serviços"
>
  Novo Serviço
        ...
        <Card className="p-6 bg-primary/5 border-2 border-primary/20">
          ...
          <ul className="mt-3 space-y-1 text-theme-secondary">
            ...
            <li>
              ✅ <strong>TimeInput</strong> - Input de duração com formatação
              inteligente
            </li>
            <li>
              ✅ <strong>ProtectedButton</strong> - Controle de acesso baseado
              em roles
            </li>
          </ul>
        </Card>
