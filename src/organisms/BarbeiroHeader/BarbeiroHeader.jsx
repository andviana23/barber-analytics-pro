        ...
        <div className="relative z-10 flex flex-col gap-6 p-6 sm:p-8">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl card-theme/15 text-2xl font-semibold uppercase backdrop-blur-sm sm:h-16 sm:w-16">
                {initials}
              </div>
              <div>
                <span className="text-xs font-medium uppercase tracking-[0.2em] text-dark-text-primary/70">
                  {greeting}
                </span>
                <h1 className="mt-1 text-2xl font-semibold leading-tight sm:text-3xl">
                  {barberName}
                </h1>
                <div className="mt-3 inline-flex items-center gap-2 rounded-full card-theme/10 px-3 py-1 text-sm text-dark-text-primary/80 backdrop-blur">
          ...
          <div className="grid grid-cols-1 gap-4 text-dark-text-primary/90 sm:grid-cols-2">
            <div className="rounded-2xl border border-light-surface dark:border-dark-surface/15 card-theme/10 p-5 backdrop-blur">
              <p className="text-xs uppercase tracking-wide text-dark-text-primary/70">
                Faturamento do m\u00eas
              </p>
              <p className="mt-2 text-3xl font-semibold text-dark-text-primary sm:text-4xl">
                {totalRevenue}
              </p>
              <span className="mt-3 inline-flex items-center gap-2 text-xs font-medium text-dark-text-primary/80">
                <Sparkles size={16} strokeWidth={2.2} />
                {totalRevenueLabel}
              </span>
            </div>

            <div className="rounded-2xl border border-light-surface dark:border-dark-surface/10 card-theme/5 p-5 backdrop-blur">
              <p className="text-xs uppercase tracking-wide text-dark-text-primary/70">
                Pontua\u00e7\u00e3o
              </p>
              <p className="mt-2 text-3xl font-semibold text-dark-text-primary sm:text-4xl">
              ...
              <span className="mt-3 inline-block text-xs font-medium text-dark-text-primary/75">
                {pointsLabel}
              </span>
            </div>
          </div>
