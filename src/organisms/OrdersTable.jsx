...
const OrdersTable = ({
  ...
  const statusOptions = [
    { value: 'all', label: 'Todos os Status', count: orders.length },
    {
      value: 'open',
      label: 'Abertas',
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {onCreateOrder && (
            <button
              ...
              className="px-4 py-2.5 bg-primary hover:bg-primary-dark text-white font-medium rounded-lg transition-colors inline-flex items-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
