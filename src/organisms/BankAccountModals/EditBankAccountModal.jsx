      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative w-full max-w-lg transform rounded-lg card-theme dark:bg-dark-surface shadow-xl transition-all">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            {/* Status da conta */}
            <div className="flex items-center gap-3 p-4 bg-light-bg dark:bg-dark-bg dark:bg-gray-700 rounded-lg">
              <input type="checkbox" name="is_active" id="is_active" checked={formData.is_active} onChange={handleInputChange} disabled={loading} className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-light-border dark:border-dark-border rounded" />
              <label htmlFor="is_active" className="text-sm font-medium text-theme-primary dark:text-dark-text-primary">
                Conta ativa
              </label>
