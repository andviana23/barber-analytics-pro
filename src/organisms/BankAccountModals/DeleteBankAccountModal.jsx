          ...
          <div className="space-y-4 p-6">
            ...
            <div className="flex items-start gap-3 rounded-lg bg-light-bg p-4 dark:bg-dark-bg dark:bg-gray-700">
              ...
              <div className="min-w-0 flex-1">
                ...
                {account.units && <p className="text-theme-secondary dark:text-theme-secondary mt-1 text-xs">
            ...
            <div>
              ...
              <input type="text" value={confirmText} onChange={e => setConfirmText(e.target.value)} placeholder={account.name} disabled={loading} className={`w-full rounded-md border px-3 py-2 shadow-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-red-500 disabled:bg-gray-50 disabled:text-gray-500 ${isConfirmValid ? 'border-green-300 bg-green-50 dark:border-green-700 dark:bg-green-900/20' : 'border-gray-300 dark:border-gray-600'} bg-white text-gray-900 dark:bg-gray-700 dark:text-white`} />
